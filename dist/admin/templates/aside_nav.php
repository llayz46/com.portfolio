...
<body class="bg-bodyBack max-w-screen flex">
  <aside class="w-fit md:w-2/12 bg-headerBack min-h-screen flex flex-col justify-between min-w-fit">
    <div class="flex flex-col">
      <a href="../index.php" class="flex md:gap-3 max-md:mx-auto items-center p-6 md:p-8 group">
        ...
        <p class="max-md:hidden textLarge text-white md:group-hover:pl-1 transition-all duration-200">llayz</p>
      </a>
