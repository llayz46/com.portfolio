...
<div class="flex w-11/12 max-w-5xl 2xl:max-w-7xl mx-auto">
  <section class="min-h-screen w-full md:w-5/6 flex flex-col gap-8 max-md:items-center md:justify-center max-md:pt-32 md:border-r border-buttonColor-borderColor-normal">
    ...
    <form class="flex flex-col max-md:justify-center w-10/12 gap-6 z-10 md:w-6/12">
      ...
      <label for="" class="flex flex-col gap-1.5 text-sm text-textColors-contactPrimary">
        Password
        <input type="text" placeholder="Must have at least 6 characters" class="placeholder:text-textColors-contactSecondary py-2 pl-3 rounded-md border border-buttonColor-borderColor-normal bg-transparent focus-visible:outline outline-1 outline-transparent focus-visible:outline-accentColor-yellow/50 caret-accentColor-yellow transition-all duration-500">
      </label>
      <input class="mt-5 md:mt-0 py-2 text-base/6 font-medium text-bodyBack bg-textColors-primary rounded-md cursor-pointer md:hover:bg-textColors-secondary transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-accentColor-yellow/60 ring-offset-2 ring-offset-headerBack" type="submit" value="Sign in">
    </form>
  </section>

  <section class="hidden min-h-screen w-1/6 md:flex items-center">
    <a href="../index.php" class="flex gap-1 items-center py-6 md:-left-1 relative bg-bodyBack scale-125 hover:scale-[1.35] transition-all">
