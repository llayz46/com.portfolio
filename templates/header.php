...
<html lang="fr-FR">
  ...
  <body>
    <!-- START : header -->
    <header class="header flux" id="home">
      <div class="header__container">
        <a href="#home" class="header__logo">
          <img
            class="header__logo-image"
            src="./assets/icons/L.svg"
            alt="Logo layz"
          />
          <p class="header__logo-text">layz</p>
        </a>

        <nav class="header__nav">
          <ul class="header__nav-list">
            <li>
              <a class="header__nav-link" href="#home">Accueil</a>
            </li>
            <li>
              <a class="header__nav-link" href="#project">Portfolio</a>
            </li>
            <li>
              <a class="header__nav-link" href="#skills">Tech</a>
            </li>
            <li>
      ...
      <div class="header__mode js-mode-select">
        <button class="header__lightmode active js-light">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
            class="header__lightmode-icon"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          <p class="header__lightmode-text">Light mode</p>
        </button>

        <button class="header__darkmode js-dark">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
            class="header__darkmode-icon"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          <p class="header__darkmode-text">Dark mode</p>
        </button>
      </div>
    </header>
    <!-- END : header -->
